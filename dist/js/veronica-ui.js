...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		define( 'jquery-validation-additional',["jquery"], factory );
	} else if (typeof module === "object" && module.exports) {
		module.exports = factory( require( "jquery" ) );
	} else {
		factory( jQuery );
...
(function(root) {
define("jquery-validation-unobtrusive", ["jquery-validation-bootstrap-tooltip","jquery-validation-additional"], function() {
  return (function() {
/*!
...
(function(factory){
    if (typeof define === 'function' && define.amd)
      define('bootstrap-datetimepicker',['jquery'], factory);
    else if (typeof exports === 'object')
...
define('veronicaExt/appExt/windowProvider',[
], function () {
