 ...
 */
(function(n){n.extend(!0,n.validator,{prototype:{defaultShowErrors:function(){var t=this;n.each(this.errorList,function(i,r){n(r.element).removeClass(t.settings.validClass).addClass(t.settings.errorClass).tooltip("destroy").tooltip(t.applyTooltipOptions(r.element,r.message)).tooltip("show");t.settings.highlight&&t.settings.highlight.call(t,r.element,t.settings.errorClass,t.settings.validClass)});n.each(t.validElements(),function(i,r){n(r).removeClass(t.settings.errorClass).addClass(t.settings.validClass).tooltip("destroy");t.settings.unhighlight&&t.settings.unhighlight.call(t,r,t.settings.errorClass,t.settings.validClass)})},applyTooltipOptions:function(t,i){var r={animation:n(t).data("animation")||!0,html:n(t).data("html")||!1,placement:n(t).data("placement")||"top",selector:n(t).data("selector")||!1,title:n(t).attr("title")||i,trigger:n.trim("manual "+(n(t).data("trigger")||"")),delay:n(t).data("delay")||0,container:n(t).data("container")||!1};return this.settings.tooltip_options&&this.settings.tooltip_options[t.name]&&n.extend(r,this.settings.tooltip_options[t.name]),this.settings.tooltip_options&&this.settings.tooltip_options._all_&&n.extend(r,this.settings.tooltip_options._all_),r}}})})(jQuery)}.apply(n,arguments)})}(this);
/*!
 ...
 * @version 0.11.1
 */
return function(n){"use strict";n.fn.tableToJSON=function(t){t=n.extend({ignoreColumns:[],onlyColumns:null,ignoreHiddenRows:!0,ignoreEmptyRows:!1,headings:null,allowHTML:!1,includeRowId:!1,textDataOverride:"data-override",textExtractor:null},t);var i=function(n){return n!==undefined&&n!==null},u=function(r){return i(t.onlyColumns)?n.inArray(r,t.onlyColumns)===-1:n.inArray(r,t.ignoreColumns)!==-1},f=function(t,r){var f={},u=0;return n.each(r,function(n,r){u<t.length&&i(r)&&(f[t[u]]=r,u++)}),f},r=function(i,r,u){var f=n(r),e=t.textExtractor,o=f.attr(t.textDataOverride);return e===null||u?n.trim(o||(t.allowHTML?f.html():r.textContent||f.text())||""):n.isFunction(e)?n.trim(o||e(i,f)):typeof e=="object"&&n.isFunction(e[i])?n.trim(o||e[i](i,f)):n.trim(o||(t.allowHTML?f.html():r.textContent||f.text())||"")},e=function(i,u){var e=[],f=t.includeRowId,o=typeof f=="boolean"?f:typeof f=="string"?!0:!1,s=typeof f=="string"==!0?f:"rowId";return o&&typeof n(i).attr("id")=="undefined"&&e.push(s),n(i).children("td,th").each(function(n,t){e.push(r(n,t,u))}),e},o=function(n){var r=n.find("tr:first").first();return i(t.headings)?t.headings:e(r,!0)},s=function(e,o){var c,y,p,b,l,v,a,h=[],s=0,w=[];return e.children("tbody,*").children("tr").each(function(u,f){var e,o,w;(u>0||i(t.headings))&&(e=t.includeRowId,o=typeof e=="boolean"?e:typeof e=="string"?!0:!1,v=n(f),w=v.find("td").length===v.find("td:empty").length?!0:!1,!v.is(":visible")&&t.ignoreHiddenRows||w&&t.ignoreEmptyRows||v.data("ignore")&&v.data("ignore")!=="false"||(s=0,h[u]||(h[u]=[]),o&&(s=s+1,typeof v.attr("id")!="undefined"?h[u].push(v.attr("id")):h[u].push("")),v.children().each(function(){for(a=n(this);h[u][s];)s++;if(a.filter("[rowspan]").length)for(p=parseInt(a.attr("rowspan"),10)-1,l=r(s,a),c=1;c<=p;c++)h[u+c]||(h[u+c]=[]),h[u+c][s]=l;if(a.filter("[colspan]").length)for(p=parseInt(a.attr("colspan"),10)-1,l=r(s,a),c=1;c<=p;c++)if(a.filter("[rowspan]").length)for(b=parseInt(a.attr("rowspan"),10),y=0;y<b;y++)h[u+y][s+c]=l;else h[u][s+c]=l;l=h[u][s]||r(s,a);i(l)&&(h[u][s]=l);s++})))}),n.each(h,function(r,e){if(i(e)){var s=i(t.onlyColumns)||t.ignoreColumns.length?n.grep(e,function(n,t){return!u(t)}):e,h=i(t.headings)?o:n.grep(o,function(n,t){return!u(t)});l=f(h,s);w[w.length]=l}}),w},h=o(this);return s(this,h)}}(jQuery),t("table-to-json",function(){}),t("utils/listUtil",["table-to-json"],function(){return function(t){function i(t,r,u,f){var o=r.parent().next().find("td.merge-cell")[u],e;o&&(e=n(o),e.is(":visible")&&e.text()===r.text()&&(++f,e.hide(),t.attr("rowspan",f),i(t,e,u,f)))}t.listUtil=t.listUtil||{};t.listUtil.SELECTED_CLASS="selected";t.listUtil.enableSelectable=function(i,r,u){var e=i.$el.find(r),f=t.listUtil.SELECTED_CLASS;u||(u="selected.list");e.on("click","tbody tr",function(t){var r=n(t.target).closest("tr");r.hasClass(f)||(r.parent().find("."+f).removeClass(f),r.addClass(f),i.trigger(u,r.data()))})};t.listUtil.enableSelectable=function(n,t,i){var r=n.$el.find(t);new kendo.ui.Selectable(r,{aria:!0,multiple:!0,filter:">*",change:function(){n.trigger(i||(i="selected.list"))}})};t.listUtil.getSelected=function(n){var t=n.find("tbody tr.k-state-selected");return t.length===0?null:t};t.listUtil.getSelectedItem=function(t,i){i==null&&(i=!1);var u=t.dataSource,r=_.map(t.select(),function(i){if(t.dataItem)return t.dataItem(n(i));var r=n(i).data().uid;return u.getByUid?u.getByUid(r):_.find(u,function(n){return n.uid===r})});return i&&(r=_.invoke(r,"toJSON")),r.length===0?null:r.length===1?r[0]:r};t.listUtil.getSelectedId=function(n){var i=t.listUtil.getSelectedItem(n);return _.isArray(i)?_.map(i,function(n){return n.id}):i===null?i:i.id};t.listUtil.confirmSelected=function(n,i){var r=t.listUtil.getSelected(n);r==null?t.notify.warn("请选择一条数据！"):i.call(this,r)};t.listUtil.toJSON=function(t){if(t.is("table")){var i=t.data();return t.tableToJSON(i)}return n.map(t.children(),function(t){return n(t).data()})};t.listUtil.checkNoData=function(n){var r=n.is("table"),i,t;r?(i=n.find("thead>tr").children().length,t=n.find("tbody").children().length,t>0?n.find(".nodata").remove():n.find("tbody").append('<tr><td class="nodata" colspan='+i+">没有任何数据！<\/td><\/tr>")):(t=n.children().length,t>0?n.find(".nodata").remove():n.append('<div class="nodata">没有任何数据！<\/div>'))};t.listUtil.mergeCells=function(t){var r=t.find("tbody"),u=r.find("tr.k-master-row");n.each(u,function(t,r){var u=n(r);n.each(u.find("td.merge-cell"),function(t,r){i(n(r),n(r),t,1)})})}}}),t("veronica-ui",["bootstrap","kendo-ui","kendo-ui-messages","./infrastructure/ajaxify","./kendo-ui/binders","./kendo-ui/culture-zh-CN","./kendo-ui/dataTable","./kendo-ui/store","./kendo-ui/viewExt","./ui/notify","./utils/formUtil","./utils/listUtil"],function(){var n=arguments;return function(t){for(var i=0,r=n.length;i<r;i++)n[i]instanceof Function&&n[i](t)}}),t("jquery",function(){return n}),i("veronica-ui")});